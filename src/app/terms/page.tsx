...
export default function Page() {
  return (
    <>
      <PageHeader title="Terms of Service" description="Replace this text with your terms. (Template placeholder)" />
      <section className="mt-10">
        <div className="container-page">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-10 max-w-3xl">
            <p className="text-white/75 leading-relaxed">
              Replace this text with your terms. (Template placeholder)
            </p>
