        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.15em] text-orange-400 mb-4">
              <span className="w-6 h-px bg-orange-500/50" />Manufacturing Network<span className="w-6 h-px bg-orange-500/50" />
            </div>
      ...
      <Container className="py-16 md:py-20">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-16">
          {outdoorWorks.map((o, idx) => (
            <div key={idx} className="group rounded-xl bg-white/[0.02] ring-1 ring-white/[0.06] hover:ring-orange-500/20 overflow-hidden transition-all duration-300 flex flex-col">
        ...
        <RevealSection>
          <div className="rounded-xl bg-white/[0.02] p-7 md:p-10 ring-1 ring-white/[0.06] mb-16">
            <div className="grid gap-10 md:grid-cols-2">
              <div>
                <div className="text-xs font-semibold uppercase tracking-[0.12em] text-orange-400 mb-2">Manufacturing Framework</div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={idx} className="rounded-lg bg-white/[0.03] hover:bg-white/[0.05] p-4 ring-1 ring-white/[0.04] hover:ring-orange-500/15 transition-all duration-300">
        ...
        <RevealSection>
          <div className="mb-16">
            <div className="text-center mb-10">
              <div className="text-xs font-semibold uppercase tracking-[0.15em] text-orange-400 mb-3">Network Details</div>
