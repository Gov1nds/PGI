    ...
    <div>
      ...
      <Container className="py-14">
        <div className="grid gap-6 md:grid-cols-2">
          {/* LEFT CARD */}
          <div className="rounded-2xl glass-card p-7 ring-white/[0.06]">
            ...
            <div className="mt-6 rounded-lg bg-navy-800/50 p-4 ring-1 ring-white/[0.04]">
              <div className="text-xs text-sky-400 font-medium">Fast option</div>
              <p className="mt-2 text-sm text-white/50">Click below to email our engineering team directly with your specifications.</p>
              <a
          ...
          {/* RIGHT CARD — Form */}
          <div className="rounded-2xl glass-card p-7 ring-white/[0.06]">
            <div className="text-sm font-bold text-white">Request a Quote</div>
            <p className="mt-2 text-sm text-white/50">Share your manufacturing requirements and we'll respond quickly on WhatsApp.</p>
            <form
            ...
            >
              <input name="name" className="w-full rounded-lg bg-navy-800/60 px-4 py-3 text-sm text-white ring-1 ring-white/[0.08] placeholder:text-white/50 focus:outline-none focus:ring-sky-500/30 transition-all" placeholder="Name" required />
              <input name="email" type="email" className="w-full rounded-lg bg-navy-800/60 px-4 py-3 text-sm text-white ring-1 ring-white/[0.08] placeholder:text-white/50 focus:outline-none focus:ring-sky-500/30 transition-all" placeholder="Email" />
              <input name="phone" className="w-full rounded-lg bg-navy-800/60 px-4 py-3 text-sm text-white ring-1 ring-white/[0.08] placeholder:text-white/50 focus:outline-none focus:ring-sky-500/30 transition-all" placeholder="Phone (WhatsApp preferred)" required />
              <textarea name="details" className="min-h-[130px] w-full rounded-lg bg-navy-800/60 px-4 py-3 text-sm text-white ring-1 ring-white/[0.08] placeholder:text-white/50 focus:outline-none focus:ring-sky-500/30 transition-all resize-none" placeholder="Describe your manufacturing requirements (e.g., CNC machining for 500 aluminum enclosures, or turnkey PCBA for 1000 units)" required />
              <button type="submit" className="btn-primary inline-flex items-center justify-center rounded-lg px-5 py-3 text-sm font-bold text-white">
