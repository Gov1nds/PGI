      ...
      <section className="border-t border-white/[0.08] py-16 md:py-20">
        <Container>
          <div className="text-center mb-10">
            <div className="text-xs font-semibold uppercase tracking-[0.15em] text-violet-400 mb-2">More Updates</div>
            ...
            {newsItems.filter((n) => n.slug !== slug).slice(0, 3).map((n, idx) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <h3 className="text-[15px] font-semibold text-white group-hover:text-violet-400 transition-colors">{n.title}</h3>
