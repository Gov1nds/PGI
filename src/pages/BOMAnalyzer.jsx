...
export default function BOMAnalyzer() {
  ...
  /* ── Workflow stage + step definitions ───────────────── */
      ...
      <div className="flex min-h-screen">
          ...
          <div className="flex-1 px-3 py-4">
            <div className="space-y-1">
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm transition bg-orange-500/15 text-orange-300"
              >
        ...
        <main className="flex-1">
            ...
            <Container className="py-4">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex items-center justify-between gap-3 lg:justify-end">
                  <button
                    onClick={() => navigate("/dashboard")}
                    className="rounded-2xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 text-sm font-medium text-white hover:bg-white/[0.07]"
                  >
                    Dashboard
                  </button>
                  <button
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-white/70 hover:bg-white/[0.06] hover:text-white"
                >
          ...
          <div className="bom-root">
            ...
            <Container className="bom-body">
              ...
              {step === 1 && (
                <FadeIn delay={100} className="bom-center-col">
                  ...
                  <PrimaryButton
                    onClick={() => { if (!file) { setError("Select a file"); return; } setError(null); setStep(2); }}
                    disabled={!file}
            ...
            {/* ── End bom-body Container ─────────────── */}

            {/* ══════════════════════════════════════════ */}
            {/* STYLES — scoped inside .bom-root          */}
            {/* ══════════════════════════════════════════ */}
            <style>{`
              ...
              .bom-card:hover { border-color: var(--border-2); }
              ...
              .bom-center-row { display: flex; justify-content: center; }
              ...
              .bom-dropzone-input { position: absolute; inset: 0; opacity: 0; cursor: pointer; }
              ...
              .bom-label { font-size: 11px; font-weight: 600; color: var(--text-3); letter-spacing: 0.04em; }
              .bom-select {
                width: 100%;
              ...
              /* ── Processing ──────────────────────────────── */
              .bom-processing { text-align: center; padding: 80px 0; }
              .bom-spinner-wrap {
                position: relative;
                width: 72px;
                height: 72px;
              ...
              .bom-processing-label { font-size: 18px; font-weight: 600; color: white; }
              .bom-processing-sub { font-size: 13px; color: var(--text-3); margin-top: 6px; }
              .bom-processing-dots {
                display: flex;
                align-items: center;
                justify-content: center;
              ...
              .bom-report-sub { font-size: 13px; color: var(--text-3); text-align: center; margin-top: 4px; }
              ...
              .bom-kpi-card:hover { border-color: var(--border-2); transform: translateY(-1px); }
              .bom-kpi-label {
                font-size: 10px;
                font-weight: 600;
                text-transform: uppercase;
              ...
              .bom-kpi-suffix { font-size: 13px; font-weight: 400; color: var(--text-3); margin-left: 2px; }
              ...
              /* ── Category pills ──────────────────────────── */
              .bom-cat-pills { display: flex; flex-wrap: wrap; align-items: center; gap: 8px; }
              .bom-cat-pills-label { font-size: 11px; color: var(--text-3); margin-right: 4px; }
              .bom-cat-pill {
                padding: 4px 12px;
                border-radius: 100px;
                background: var(--surface-2);
              ...
              .bom-table-title { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-3); }
              ...
              .bom-locked-badge > span { font-size: 12px; color: var(--text-2); font-weight: 500; }
              .bom-locked-badge svg { color: var(--text-3); }

              /* ── Split grid ──────────────────────────────── */
              .bom-split-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
              @media (max-width: 640px) { .bom-split-grid { grid-template-columns: 1fr; } }
              ...
              .bom-region-pct { width: 36px; text-align: right; font-family: var(--mono); font-size: 11px; color: var(--text-3); }

              /* ── Recommendation ──────────────────────────── */
              .bom-recommendation-text { font-size: 13px; color: var(--text-2); line-height: 1.65; }

              /* ── CTA card ────────────────────────────────── */
              .bom-cta-card { position: relative; border-radius: var(--radius); overflow: hidden; }
              .bom-cta-bg {
                position: absolute;
                inset: 0;
              ...
              .bom-cta-content { position: relative; padding: 44px 32px; text-align: center; }
              .bom-cta-title { font-size: 22px; font-weight: 700; color: white; letter-spacing: -0.01em; }
              .bom-cta-desc {
                font-size: 14px;
                color: var(--text-2);
                max-width: 420px;
              ...
              .bom-cta-actions { display: flex; flex-direction: column; align-items: center; gap: 12px; }
              .bom-cta-btn {
                display: inline-flex;
                padding: 13px 32px;
                background: var(--accent);
              ...
              .bom-cta-link { font-size: 13px; color: var(--text-3); text-decoration: none; transition: color 0.2s; }
              .bom-cta-link:hover { color: var(--text-2); }
              .bom-cta-features { display: flex; flex-wrap: wrap; justify-content: center; gap: 16px; margin-top: 28px; }
              .bom-cta-feature { font-size: 11px; color: var(--text-3); }
              ...
              .bom-tab.active { background: var(--accent); color: white; box-shadow: 0 2px 12px rgba(249,115,22,0.2); }
              ...
              .bom-cost-label { width: 110px; font-size: 12px; color: var(--text-2); flex-shrink: 0; }
              .bom-cost-track { flex: 1; height: 7px; background: rgba(255,255,255,0.03); border-radius: 100px; overflow: hidden; }
              .bom-cost-fill { height: 100%; border-radius: 100px; }
              .bom-cost-val { width: 100px; text-align: right; font-family: var(--mono); font-size: 12px; color: var(--text-2); }
              ...
              .bom-decision-legend { display: flex; justify-content: space-between; margin-top: 8px; font-size: 10px; font-weight: 600; }
              .bom-legend-exploit { color: var(--accent); }
              .bom-legend-explore { color: var(--warn); }

              /* ── Component cards ─────────────────────────── */
              .bom-comp-group { margin-bottom: 8px; }
              .bom-comp-group-header { display: flex; align-items: center; gap: 8px; margin-bottom: 12px; padding-top: 4px; }
              .bom-comp-group-dot { width: 8px; height: 8px; border-radius: 50%; }
              .bom-comp-group-title { font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; color: var(--text-2); }
              ...
              .bom-comp-name { font-size: 13px; font-weight: 600; color: white; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
              ...
              .bom-comp-chevron { color: var(--text-3); transition: transform 0.25s; flex-shrink: 0; }
              ...
              .bom-detail-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; color: var(--text-3); }
              .bom-detail-grid {
                display: grid;
