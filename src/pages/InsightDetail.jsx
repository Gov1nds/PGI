        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/[0.06] ring-1 ring-white/[0.1] flex items-center justify-center text-xs font-bold text-white/70">P</div>
              <div>
      ...
      <section className="border-t border-white/[0.08] py-16 md:py-20">
        <Container>
          <div className="text-center mb-10">
            <div className="text-xs font-semibold uppercase tracking-[0.15em] text-white/70 mb-2">More Insights</div>
            ...
            {insights.filter((i) => i.slug !== slug).slice(0, 3).map((i, idx) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <h3 className="text-[15px] font-semibold text-white group-hover:text-white/70 transition-colors">{i.title}</h3>
