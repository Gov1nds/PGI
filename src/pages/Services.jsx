    ...
    <div>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.15em] text-sky-400 mb-4">
              <span className="w-6 h-px bg-sky-500/50" />Services<span className="w-6 h-px bg-sky-500/50" />
            </div>
        ...
        <section className="border-b border-white/[0.04] py-16 md:py-20">
          <Container>
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {services.map((s, idx) => (
                <div key={idx} className="group rounded-xl bg-navy-800/40 p-5 ring-1 ring-white/[0.06] hover:ring-sky-500/20 transition-all duration-300 flex flex-col">
                  ...
                  <h3 className="text-base font-semibold text-white group-hover:text-sky-400 transition-colors">{s.title}</h3>
                  <p className="mt-2 text-sm text-white/50 leading-relaxed">{s.desc}</p>
                  <div className="mt-4 pt-4 border-t border-white/[0.06]">
                    <p className="text-[11px] font-semibold uppercase tracking-wider text-sky-400/70 mb-2.5">Key Benefits</p>
        ...
        <section className="border-b border-white/[0.04] py-16 md:py-20">
          <Container>
            <div className="text-center mb-12">
              <div className="text-xs font-semibold uppercase tracking-[0.15em] text-sky-400 mb-3">Detailed Capabilities</div>
              <h2 className="text-3xl font-bold text-white">Manufacturing Excellence</h2>
            </div>
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="rounded-xl bg-navy-800/40 ring-1 ring-white/[0.06] hover:ring-sky-500/15 p-6 transition-all duration-300">
      ...
      <RevealSection>
        <section className="py-16 md:py-20">
          <Container>
            <div className="text-center mb-12">
              <div className="text-xs font-semibold uppercase tracking-[0.15em] text-sky-400 mb-3">Our Process</div>
              <h2 className="text-3xl font-bold text-white">How We Deliver</h2>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {[
                ...
                <div key={idx} className="text-center p-4">
                  <div className="rounded-xl w-14 h-14 bg-sky-500/10 ring-1 ring-sky-500/20 flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-14 border-t border-white/[0.04]">
        <Container>
          <div className="rounded-2xl bg-gradient-to-r from-sky-500/10 via-violet-500/5 to-cyan-500/5 p-10 text-center ring-1 ring-sky-500/10">
            ...
            <p className="mt-3 text-white/50 text-sm">Get a free engineering review and quotation</p>
