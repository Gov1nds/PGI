        ...
        <section className="border-b border-white/[0.04] py-16 md:py-20">
          <Container>
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {services.map((s, idx) => (
                <div key={idx} className="group rounded-xl bg-white/[0.02] p-5 ring-1 ring-white/[0.06] hover:ring-sky-500/20 transition-all duration-300 flex flex-col">
          ...
          <Container>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="rounded-xl bg-white/[0.02] ring-1 ring-white/[0.06] hover:ring-sky-500/15 p-6 transition-all duration-300">
