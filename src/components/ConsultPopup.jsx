...
export default function ConsultPopup({ delayMs = 10000 }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-navy-800 ring-1 ring-white/[0.08] p-8 shadow-2xl shadow-black/40">
        <button
          onClick={dismiss}
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-sky-500/10 ring-1 ring-sky-500/20 mb-4">
