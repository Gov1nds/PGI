  ...
  return (
    <Wrapper
      ...
      className={`group block overflow-hidden rounded-2xl bg-white/[0.05] ring-1 ring-white/[0.08] transition-all duration-300 hover:bg-white/[0.06] ${
        to ? "hover:ring-white/[0.12] hover:shadow-lg hover:shadow-white/[0.02]" : ""
      }`}
    >
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[rgb(9,9,11)] via-transparent to-transparent opacity-60" />
        {tag && (
      ...
      <div className="p-5">
        ...
        {to && <div className="mt-4 text-sm font-semibold text-white/70 group-hover:text-white/60 transition-colors">Read more →</div>}
      </div>
    </Wrapper>
  );
}
