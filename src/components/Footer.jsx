        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-sm font-semibold text-white">PGI <span className="text-blue-400">Hub</span></div>
            ...
            <div className="mt-5 space-y-2 text-sm text-white/80">
              <div className="flex items-center gap-2">
                <svg className="w-3.5 h-3.5 text-blue-500/50" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {navLinks.slice(0, 5).map((l) => (
                <li key={l.to}>
                  <Link to={l.to} className="text-sm text-white/80 hover:text-blue-400 transition-colors duration-200">{l.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <Link
                to="/bom-analyzer"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-500/10 px-4 py-2.5 text-sm font-semibold text-blue-400 ring-1 ring-blue-500/20 hover:bg-blue-500/20 transition-all duration-300"
              >
