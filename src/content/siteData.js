...
export const heroStats = [
  { kpi: "Electronics", label: "Components sourced globally" },
  { kpi: "Machining", label: "Manufacturing partners evaluated" },
  { kpi: "Assembly", label: "Production coordination capability" },
  { kpi: "Quality", label: "Inspection & verification process" }
];
